    ...
    return (
        <div className="result-div" id="image_result">
            ...
            <div className="result-image">
                ...
                <button onClick={() => window.location.href=itemHref(props.item)} style={{marginTop: '40px'}}>View item</button>
                <button onClick={saveImage} style={{marginTop: '40px'}}>Save image</button>
            </div>
        </div>
    );
}