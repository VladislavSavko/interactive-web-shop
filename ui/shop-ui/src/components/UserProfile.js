                ...
                <div className="row ">
                    <div className="col-xl-6 col-lg-6">
                        <div className="card l-bg-cherry">
                            <div className="card-statistic-3 p-4">
                                <div className="mb-4">
                                    <h2 style={{borderBottom: '3px solid #ccc', paddingBottom: '5px', textAlign: 'center'}}>General info</h2>
                                    ...
                                    <div style={{alignItems: 'center', display: 'flex'}}>
                                        <img style={{maxWidth: '35px', maxHeight: '35px', paddingBottom: '4px', paddingRight: '7px'}}
                    ...
                    <div className="col-xl-6 col-lg-6">
                        <div className="card l-bg-blue-dark">
                            <div className="card-statistic-3 p-4">
                                <div className="mb-4">
                                    <h2 style={{borderBottom: '3px solid #ccc', paddingBottom: '5px', textAlign: 'center'}}>Address info</h2>
                                    <div style={{alignItems: 'center', display: 'flex'}}>
                                        <img style={{maxWidth: '35px', maxHeight: '35px', paddingBottom: '7px'}}
                                    ...
                                    <div style={{alignItems: 'center', display: 'flex'}}>
                                        <img style={{maxWidth: '35px', maxHeight: '35px', paddingBottom: '7px', paddingLeft: '3px'}}
