        ...
        return httpSecurity
                .authorizeExchange(
                        authorizationManagerRequestMatcherRegistry -> authorizationManagerRequestMatcherRegistry
                                ...
                                .hasAuthority("ADMIN")
                                .pathMatchers(HttpMethod.GET, "/api/v1/shop/items/forFr")
                                .hasAnyAuthority("CLIENT", "ADMIN")
                                .pathMatchers(HttpMethod.GET, "/api/v1/shop/items", "/api/v1/shop/items/{id}", "/api/v1/shop/categories/**")
                                .permitAll()
                                .pathMatchers(HttpMethod.POST, "/api/v1/users/**", "/api/v1/shop/items/search/**")
                                .permitAll()
                                ...
                                .hasAnyAuthority("CLIENT", "ADMIN")
                                .pathMatchers(HttpMethod.PUT, "/api/v1/shop/cart/**")
